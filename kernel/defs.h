...
// vm.c
pagetable_t     getgp();
int             up2kp(pagetable_t, pagetable_t, uint64, uint64);
void            kvminit(void);
void            pkvminit(struct proc *);
...
void            uvmunmap2(pagetable_t, uint64, uint64, int);
...
void            vmprint2(pagetable_t, pagetable_t, int);
